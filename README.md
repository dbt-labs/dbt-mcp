...
- `get_job_run_artifacts`: Downloads a specific artifact from a job run; large artifacts are cached to ~/.dbt/artifacts/ instead of returned inline; supports jq filtering.
