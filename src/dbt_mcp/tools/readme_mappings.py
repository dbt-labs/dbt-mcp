...
HUMAN_DESCRIPTIONS: dict[ToolName, str] = {
    ...
    ToolName.GET_JOB_RUN_ARTIFACTS: "Downloads a specific artifact from a job run; large artifacts return a guidance message to retry with a jq_filter; supports jq filtering for targeted extraction.",
