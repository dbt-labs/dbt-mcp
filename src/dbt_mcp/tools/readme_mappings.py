...
HUMAN_DESCRIPTIONS: dict[ToolName, str] = {
    ...
    ToolName.GET_JOB_RUN_ARTIFACTS: "Downloads a specific artifact from a job run; large artifacts are cached to ~/.dbt/artifacts/ instead of returned inline; supports jq filtering.",
