...
HUMAN_DESCRIPTIONS: dict[ToolName, str] = {
    ...
    ToolName.GET_JOB_RUN_ARTIFACTS: "Downloads a specific artifact from a job run; supports inline string, auto-temp file for large artifacts, and jq filtering.",
