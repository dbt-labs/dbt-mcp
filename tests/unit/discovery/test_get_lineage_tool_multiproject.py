...
async def test_multiproject_get_lineage_builds_graph_from_nodes():
    """The multiproject get_lineage maps the fetcher's nodes into a LineageGraph
    (nodes + edges), matching the single-project tool's structured output."""
    nodes = [
